...
write.csv(submit_full, "./H2O_submits/H2O_GBM_12_05_200_full",row.names=F)
...
cat("saving the submission file\n")
write.csv(submit_A, "./H2O_submits/H2O_GBM_12_05_200_A",row.names=F)
...
cat("saving the submission file\n")
write.csv(submit_B, "./H2O_submits/H2O_GBM_12_05_200_B",row.names=F)
...
####################################################################################
temp   = read.csv('./H2O_submits/H2O_GBM_12_05_200_A_train.csv', sep = ",")
train_B$trainAB = log1p(temp$Sales)
mean(log1p(temp$Sales))

temp   = read.csv('./H2O_submits/H2O_GBM_12_05_200_B_train.csv', sep = ",")
train_A$trainAB = log1p(temp$Sales)
mean(log1p(temp$Sales))

temp   = read.csv('./H2O_submits/H2O_GBM_12_05_200_full', sep = ",")
test$trainAB = log1p(temp$Sales)
mean(log1p(temp$Sales))

mean(log1p(test_pred_full))
mean(log1p(test_pred_A))
mean(log1p(test_pred_B))
mean(test$trainAB)


tempA   = read.csv('./H2O_submits/H2O_GBM_12_05_200_A', sep = ",")
tempB   = read.csv('./H2O_submits/H2O_GBM_12_05_200_B', sep = ",")
mean(log1p(tempA$Sales))
mean(log1p(tempB$Sales))


head(as.data.frame(h2o.predict(gbmHex_A,testHex)))
head(as.data.frame(h2o.predict(gbmHex_B,testHex)))
head(as.data.frame(h2o.predict(gbmHex_full,testHex)))
...
temp   = read.csv('./H2O_submits/h2o_GBM_12_05_800_top80_train_v2.csv', sep = ",")
train_new$GBM_800_top80 = temp$Sales

temp   = read.csv('./H2O_submits/h2o_GBM_12_05_800_top80_v2.csv', sep = ",")
test$GBM_800_top80 = temp$Sales

temp   = read.csv('./H2O_submits/h2o_GBM_20_05_300_v3_d_train.csv', sep = ",")
train_new$GBM_800_d = temp$Sales

temp   = read.csv('./H2O_submits/h2o_GBM_20_05_300_v3_d.csv', sep = ",")
test$GBM_800_top80_d = temp$Sales

temp   = read.csv('./H2O_submits/h2o_GBM_20_05_300_v3_c_train.csv', sep = ",")
train_new$GBM_800_c = temp$Sales

temp   = read.csv('./H2O_submits/h2o_GBM_20_05_300_v3_c.csv', sep = ",")
test$GBM_800_top80_c = temp$Sales

temp   = read.csv('./H2O_submits/h2o_GBM_20_05_300_v3_b_train.csv', sep = ",")
train_new$GBM_800_b = temp$Sales

temp   = read.csv('./H2O_submits/h2o_GBM_20_05_300_v3_b.csv', sep = ",")
test$GBM_800_top80_b = temp$Sales

temp   = read.csv('./H2O_submits/h2o_GBM_20_05_300_v3_a_train.csv', sep = ",")
train_new$GBM_800_a = temp$Sales

temp   = read.csv('./H2O_submits/h2o_GBM_20_05_300_v3_a.csv', sep = ",")
test$GBM_800_top80_a = temp$Sales

####################################################################################
names(train_new)
train_newHex    = as.h2o(train_new)
features        = c(features, "trainAB", "GBM_800_top80", "GBM_800_a", "GBM_800_b", "GBM_800_c", "GBM_800_d")
